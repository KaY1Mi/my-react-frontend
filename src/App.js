      ...
      <LanguageProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/pro-site-one" element={<ProLesson1 />} />
            <Route path="/pro-site-two" element={<ProLesson2/>} />
            <Route path="/pro-site-three" element={<ProLesson3/>} />
            <Route path="/ux-one" element={<Ux1/>} />
            <Route path="/ux-two" element={<Ux2/>} />
            <Route path="/ux-three" element={<Ux3/>} />
