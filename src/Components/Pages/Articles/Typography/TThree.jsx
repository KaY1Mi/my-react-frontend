...
// импорт изображений 
import a14 from '../../../../Image/webp/articles/article_3.webp'
        ...
        <main ref={addToRefs} className={`${isMobile ? 'min-h-screen' : 'h-screen'}`}>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 text-center left-0 bg-black bg-opacity-50 right-0 p-4">
                <h1 className="stat-item stat-top text-6xl font-bebas text-neutal-white md:text-7xl xl:text-[250px] 2xl:text-[350px] leading-none ">{t.article_typo3_h1}</h1>
            </div>
          </div>
