...
const FigmaLesson3 = () => {
        ...
        <div>
            <main className='h-screen'>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-10 xl:my-5">
                    <img src={figma_main} alt="Figma animation" className='w-full col-span-full h-[450px] object-cover md:h-[700px]' />
                    <p className='stat-item stat-left pt-7 text-base font-manrope col-span-full mx-2.5 md:pt-5 md:text-lg lg:text-xl lg:pt-10 xl:col-span-6 xl:pt-10'>
                        {t.figma_lesson3_intro}
                    </p>
                </div>
            </main>

            <section className="mx-2.5 grid grid-cols-2 md:grid-cols-4 xl:grid-cols-10 my-5 md:mx-5">
                <h2 className='stat-item stat-top col-span-full font-bebas text-6xl md:text-7xl lg:text-8xl'>{t.figma_lesson3_main_title}</h2>
                <div className="col-span-full">
                    <div className="stat-item stat-left flex flex-col mt-5 py-5 border-b border-neutal-grey xl:flex-row xl:justify-between xl:items-start">
                        <h3 className='text-4xl font-bebas'>{t.figma_lesson3_section1_title}</h3>
                        <p className='text-sm font-manrope pt-5 text-neutal-grey md:text-lg lg:text-xl xl:pt-0 xl:w-[60%]'>
                            {t.figma_lesson3_section1_content}
                        </p>
                    </div>
                    ...
                    <div className="stat-item stat-right flex flex-col mt-5 py-5 border-b border-neutal-grey xl:flex-row xl:justify-between xl:items-start">
                        <h3 className='text-4xl font-bebas'>{t.figma_lesson3_section2_title}</h3>
                        <p className='text-sm font-manrope pt-5 text-neutal-grey md:text-lg lg:text-xl xl:pt-0 xl:w-[60%]'>
                            {t.figma_lesson3_section2_content}
                        </p>
                    </div>
                    ...
                    <div className="stat-item stat-bottom flex flex-col mt-5 py-5 border-b border-neutal-grey xl:flex-row xl:justify-between xl:items-start">
                        <h3 className='text-4xl font-bebas'>{t.figma_lesson3_section3_title}</h3>
                        <ul className='pt-5 list-disc list-inside space-y-2 xl:pt-0 xl:w-[60%]'>
                           <li className='text-sm font-manrope text-neutal-grey md:text-lg lg:text-xl'>{t.figma_lesson3_list_item1}</li>
                           <li className='text-sm font-manrope text-neutal-grey md:text-lg lg:text-xl'>{t.figma_lesson3_list_item2}</li>
                           <li className='text-sm font-manrope text-neutal-grey md:text-lg lg:text-xl'>{t.figma_lesson3_list_item3}</li>
                           <li className='text-sm font-manrope text-neutal-grey md:text-lg lg:text-xl'>{t.figma_lesson3_list_item4}</li>
                        </ul>
                    </div>
                </div>
            </section>
  ...
  ></iframe>
                ...
                >
                    {t.figma_lesson3_complete_button}
                </button>
            </section>
