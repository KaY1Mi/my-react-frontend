...
const VacancieSix = () => {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e) => {
      ...
      const newSection = Math.max(
        0,
        Math.min(currentSection + direction, sectionsRef.current.length - 1)
      );
  ...
  return (
    <div className={`overflow-hidden bg-white ${isMobile ? 'overflow-y-auto' : 'h-screen'}`}>
      ...
      <section
        ref={addToRefs}
        className={`bg-black px-2.5 grid grid-cols-2 gap-5 md:grid-cols-4 xl:grid-cols-10 py-5 md:px-5 xl:h-screen`}
      >
        ...
        <div className="col-span-2 pt-5 md:col-span-2 md:col-start-3 lg:col-span-2 xl:col-span-4 xl:col-start-6">
          <h4 className="stat-item stat-right font-bebas text-2xl col-span-2 md:col-span-2 md:text-4xl lg:col-span-2 xl:col-span-6 xl:col-start-6 text-white">
            {t.h5_vac}
          </h4>
          <ul className="stat-item stat-right list-inside space-y-5 pt-5 list-disc col-span-2 md:col-span-2 lg:col-span-2 xl:col-start-6 xl:col-span-4 ">
            <li className="font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl">
              {t.vac_list_six_one}
            </li>
            <li className="font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl">
              {t.vac_list_six_two}
        ...
        <img
          src={img3}
          className="hidden md:col-span-full stat-item stat-bottom w-full object-cover md:block rounded-[10px] h-[250px] lg:h-[350px]"
          alt="Workplace"
      ...
      >
        ...
        <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-left">
          <h3 className="font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl">
            {t.h3_vac_wish_six_one}
          </h3>
          <p className="font-manrope text-sm text-neutal-white uppercase md:text-xl">{t.p_vac_wish_six_one}</p>
        </div>
        ...
        <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
          <h3 className="font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl">
            {t.h3_vac_wish_six_three}
          </h3>
          <p className="font-manrope text-sm text-neutal-white uppercase md:text-xl">{t.p_vac_wish_six_three}</p>
        </div>
        ...
        <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
          ...
          <p className="font-manrope text-sm text-neutal-white uppercase md:text-xl">{t.p_vac_wish_six_four}</p>
        </div>
        ...
        <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
          ...
          <p className="font-manrope text-sm text-neutal-white uppercase md:text-xl">{t.p_vac_wish_six_five}</p>
        </div>
        ...
        <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
          ...
          <p className="font-manrope text-sm text-neutal-white uppercase md:text-xl">{t.p_vac_wish_six_six}</p>
        </div>
      ...
      {showLogoutModal && <PopupVacancie onClose={() => setShowLogoutModal(false)} onConfirm={handleFeedBack} />}
