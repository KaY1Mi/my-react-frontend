        ...
        <div className={`overflow-hidden bg-white ${isMobile ? 'overflow-y-auto' : 'h-screen'}`}>
            ...
            <section ref={addToRefs} className={`bg-black px-2.5 grid grid-cols-2 gap-5 md:grid-cols-4 xl:grid-cols-10 py-5 md:px-5 xl:h-screen`}>
                ...
                <div className="col-span-2 pt-5 md:col-span-2 md:col-start-3 lg:col-span-2 xl:col-span-4 xl:col-start-6">
                    <h4 className='stat-item stat-right font-bebas text-2xl col-span-2 md:col-span-2 md:text-4xl lg:col-span-2 xl:col-span-6 xl:col-start-6 text-white'>{t.h5_vac1}</h4>
                    <ul className="stat-item stat-right list-inside space-y-5 pt-5 list-disc col-span-2 md:col-span-2 lg:col-span-2 xl:col-start-6 xl:col-span-4 ">
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_one1}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_two1}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three1}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_four1}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_five1}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_six1}</li>  
                    </ul>   
                </div>
            ...
            <section ref={addToRefs} className={`bg-black px-2.5 grid grid-cols-2 gap-5 md:grid-cols-4 xl:grid-cols-10 py-5 md:px-5 xl:h-screen`}>
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-left">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_one1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_one1}</p>
                </div>
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-4 xl:stat-item xl:stat-top">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_two1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_two1}</p>
                </div>
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three1}</p>
                </div>   
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-left">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_four1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_four1}</p>
                </div>  
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-4 xl:stat-item xl:stat-top">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_five1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_five1}</p>
                </div>  
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_six1}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_six1}</p>
                </div>

                <button onClick={() => setShowLogoutModal(true)} className='col-span-full w-full bg-white opacity-50 font-bebas rounded-[10px] h-[80px] text-2xl xl:text-3xl hover:bg-white hover:opacity-100 transition-all duration-500'>{t.btn_feedback1}</button>  
            </section>
