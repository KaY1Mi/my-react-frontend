        ...
        <div className={`overflow-hidden bg-white ${isMobile ? 'overflow-y-auto' : 'h-screen'}`}>
            ...
            <section ref={addToRefs} className={`bg-black px-2.5 grid grid-cols-2 gap-5 md:grid-cols-4 xl:grid-cols-10 py-5 md:px-5 xl:h-screen`}>
                ...
                <div className="col-span-2 pt-5 md:col-span-2 md:col-start-3 lg:col-span-2 xl:col-span-4 xl:col-start-6">
                    ...
                    <ul className="stat-item stat-right list-inside space-y-5 pt-5 list-disc col-span-2 md:col-span-2 lg:col-span-2 xl:col-start-6 xl:col-span-4 ">
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_one}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_two}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_three}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_four}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_five}</li>
                        <li className='font-manrope font-thin text-white text-[15px] md:text-base xl:text-xl'>{t.vac_list_three_six}</li>  
                    </ul>   
                </div>
            ...
            <section ref={addToRefs} className={`bg-black px-2.5 grid grid-cols-2 gap-5 md:grid-cols-4 xl:grid-cols-10 py-5 md:px-5 xl:h-screen`}>
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-left">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_one}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_one}</p>
                </div>
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-4 xl:stat-item xl:stat-top">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_two}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_two}</p>
                </div>
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_three}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_three}</p>
                </div>   
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-left">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_four}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_four}</p>
                </div>  
                ...
                <div className="stat-item stat-left col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-4 xl:stat-item xl:stat-top">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_five}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_five}</p>
                </div>  
                ...
                <div className="stat-item stat-right col-span-1 h-[200px] px-[5px] py-2.5 border-b border-white md:col-span-2 md:h-[310px] flex flex-col justify-between xl:col-span-3 xl:stat-item xl:stat-right">
                    <h3 className='font-bebas text-4xl text-neutal-blue md:text-6xl lg:text-7xl 2xl:text-8xl'>{t.h3_vac_wish_three_six}</h3>
                    <p className='font-manrope text-sm text-neutal-white uppercase md:text-xl'>{t.p_vac_wish_three_six}</p>
                </div>
